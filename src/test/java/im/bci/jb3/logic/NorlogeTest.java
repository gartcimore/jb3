...
public class NorlogeTest {
    ...
    public void testParseNorloges() {
        ...
        expResult.add(new Norloge().withTime(DateTime.now(LegacyUtils.legacyTimeZone).withYear(2016).withMonthOfYear(1).withDayOfMonth(6).withHourOfDay(21).withMinuteOfHour(14).withSecondOfMinute(21).withMillisOfSecond(0)));
