                      ...
                      if (s9 !== peg$FAILED) {
                        ...
                        if (s10 !== peg$FAILED) {
                          ...
                          if (s11 !== peg$FAILED) {
                            ...
                            if (s12 !== peg$FAILED) {
                              peg$savedPos = s0;
                              s1 = peg$c28(s1, s3, s5, s7, s9, s11, s12);
                              s0 = s1;
                            } else {
                              peg$currPos = s0;
                              s0 = peg$FAILED;
