...
NextRTC.prototype.on = function(signal, operation) {
    this.signals[signal] = operation;
};

NextRTC.prototype.create = function(convId, custom) {
    var nextRTC = this;
...
NextRTC.prototype.join = function(convId, custom) {
    var nextRTC = this;
    navigator.mediaDevices.getUserMedia(nextRTC.mediaConfig).then(function(stream) {
        nextRTC.localStream = stream;
        nextRTC.call('localStream', {
...
NextRTC.prototype.leave = function() {
    var nextRTC = this;
